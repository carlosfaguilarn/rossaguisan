  ...
  $this->blockjustfinished=false;
    ...
    case 'ADDRESS': 
      ...
      if ( !isset($attr['TYPE']) or $attr['TYPE'] == '' ) $this->listtype = '1'; //OL default == '1'
		...
		case 'UL':
      if ( (!isset($attr['TYPE']) or $attr['TYPE'] == '') and ($this->listtype != '1') ) $this->listtype = 'disc'; //UL default == 'disc'
      elseif ($this->listtype != '1') $this->listtype = $attr['TYPE']; // ol and ul types are mixed here
      $this->buffer_on = false;
      if ($this->listlvl == 0)
      {
