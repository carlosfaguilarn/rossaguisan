     ...
     <section>
            ...
            <div class='container'>
                <div class='details clearfix'>
                    <div class='client left'> 
                        <span class='name'>Cliente: </span>($prestamo->CLIENTE_ID) $prestamo->NOMBRE $prestamo->APELLIDO</span> <br>
                        <span class='name'>Préstamo: </span>$".number_format($prestamo->IMPORTE)."</span> <br>
                        <span class='name'>Plazo: </span> Del $prestamo->FECHA_INICIO al $prestamo->FECHA_FIN </span> <br>
                    </div>
                    <div class='data right'>
                        <div class='title'>Recibo de Abono</div>
                        <span class='name'>Fecha de abono: </span>$ultimo_abono->FECHA</span> <br>
                    </div>
                </div>
                        ...
                        for($i=0; $i<=sizeof($abonos); $i++){
                            if(isset($abonos[$i])){
                                ...
                                "<tr> 
                                    ...
                                    <td class='qty'>$".number_format($item->ABONO)."</td> 
                                    <td class='unit'>$".number_format($item->SALDO)."</td>
                                ...
                                if($i % 13 == 0 && $i > 0){
                                    ...
                                    <div class='details clearfix'>
                                        <div class='client left'>
                                            <span class='name'>Cliente: </span>$prestamo->NOMBRE $prestamo->APELLIDO</span> <br>
                                            <span class='name'>Préstamo: </span>$".number_format($prestamo->IMPORTE)."</span> <br>
                                            <span class='name'>Plazo: </span> Del $prestamo->FECHA_INICIO al $prestamo->FECHA_FIN </span> <br>
                                        </div>
                                        <div class='data right'>
        ...
        <footer class='foot'>
            <div class='container'>
                ...
                <div class='notice'>
                    <div>NOTA:</div>
                    <div>Este recibo es solo informativo, cualquier aclaración llame al número 6681110599.</div>
                </div>
